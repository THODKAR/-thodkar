...
root.title("MUKESH RAO calculator")
scvalue=StringVar()
scvalue.set("")
...
b=Button(f,text="1",padx=30.5,pady=18,font="lucida 35 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="0",padx=30.5,pady=18,font="lucida 35 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="/",padx=30.5,pady=18,font="lucida 35 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)
